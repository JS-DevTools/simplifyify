...
describe("simplifyify --debug", () => {
  it("should create source map for a single file", (done) => {
    cli.run("es5/lib/index.js --debug --outfile es5/dist/index.js", (err, stdout) => {
      if (err) {
        return done(err);
      }
  ...
  it("should create source maps for multiple files", (done) => {
    cli.run("es5/lib/**/*.js --debug --outfile es5/dist/", (err, stdout) => {
      if (err) {
        return done(err);
      }
  ...
  it("should create source maps for multiple minified files", (done) => {
    cli.run("es5/lib/**/index.js --bundle --debug --minify --outfile es5/dist/", (err, stdout) => {
      if (err) {
        return done(err);
      }
  ...
  it('should append ".map" when renaming output files', (done) => {
    cli.run("es5/lib/**/*.js --bundle --debug --minify --outfile es5/dist/*.bundle.es", (err, stdout) => {
      if (err) {
        return done(err);
      }
  ...
  it("should create a sourcemap for a bundle with a banner", (done) => {
    cli.run("hello/index.js --debug --outfile hello/dist/", (err, stdout) => {
      if (err) {
        return done(err);
      }
